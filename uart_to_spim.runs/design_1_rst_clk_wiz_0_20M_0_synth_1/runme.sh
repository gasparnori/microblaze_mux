...
HD_PWD='D:/Nora/Intan_project/USB/USB.runs/design_1_rst_clk_wiz_0_20M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_20M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_20M_0.tcl
