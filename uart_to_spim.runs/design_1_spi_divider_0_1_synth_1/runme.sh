...
HD_PWD='D:/Nora/Intan_project/uart_to_spim/uart_to_spim.runs/design_1_spi_divider_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spi_divider_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spi_divider_0_1.tcl
