...
HD_PWD='D:/Nora/Intan_project/uart_to_spim/uart_to_spim.runs/design_1_debug2gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_debug2gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_debug2gpio_0_0.tcl
