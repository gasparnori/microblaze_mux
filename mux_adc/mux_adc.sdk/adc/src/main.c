...
int ADCInit( XSysMon *SysMonitor){
...
int readADC(XSysMon *Mon){
	u16 value=XSysMon_GetAdcData(Mon, XSM_CH_VCCAUX);
	printf("value: %x\r\n", value);
}
...
int main() 
{
   ...
   int ADCtest=ADCInit(&SysMonitor);
   printf("......\r\n");
   if ( gpiotest == XST_SUCCESS && MUXtest == XST_SUCCESS && ADCtest==XST_SUCCESS) {
